...
def parse_arguments():
    ...
    # ---add expense---
    add_parser = subparsers.add_parser("add", help="Add new expense entry")
    ...
    list_parser.add_argument("-d","--date", default=None, type=int, choices=range(1, 32), metavar="DD",  help="Filter by date (1–31)")
    ...
    summary_parser.add_argument("-m","--month", default=None, type=int, choices=range(1, 13), metavar="MM",  help="Summary filtered by month (1–12)")
